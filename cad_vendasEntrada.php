...
{ 
    ...
    $resultado = mysqli_query($conexao,"select * from cad_fornecedor order by razao_social");
...
<div class="container card-body card" style="padding: 50px; margin-top: 200px">
    ...
    <form method="get" action="cad_vendasEntradaCONEXAO.php" class="form-group">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-12" style="margin: 20px; text-align: center">
                <button class="btn btn-primary" type="submit" name="btncal">Iniciar Entrada</button>
