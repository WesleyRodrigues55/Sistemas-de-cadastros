    ...
    <nav class="navegacao">
        <div class="row">
            ...
            <div class="col-md-2">
                <!-- icone home -->
                <div class="icones">
                    <button type="buttom" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="HOME"><a href="index.php"><svg xmlns="http://www.w3.org/2000/svg" id="icone" width="30" height="30" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
    ...
    <section class="container">
        ...
        <div class="row" style="margin-top: 100px;">
            <div class="col-md-6" style="padding: 30px;">
                <h2 style="color: rgb(135, 135, 197)">Quem somos?</h2>
