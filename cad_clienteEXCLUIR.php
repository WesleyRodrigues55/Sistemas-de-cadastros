...
<body>
    ...
    <nav class="navegacao">
        <div class="row">
            ...
            <div class="col-md-2">
                <!-- icone usuario -->
                <div class="icones">
                    <button type="buttom" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Clique aqui para cadastrar um novo usuario"><a href="cad_clienteVIEW.php"><svg xmlns="http://www.w3.org/2000/svg" id="icone" width="30" height="30" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
    ...
    <section class="container-fluid">
        ...
        <form method="post" name="cliente" action="cad_clienteAPAGAR-LINHA.php">
            <div class="row">
                <div class="col-md-12">
