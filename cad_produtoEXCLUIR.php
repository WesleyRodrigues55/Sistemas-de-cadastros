    ...
    <nav class="navegacao">
        <div class="row">
            ...
            <div class="col-md-2">
                <!-- icone usuario -->
                <div class="icones">
                    <button type="buttom" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Clique aqui para cadastrar um novo usuario"><a href="cad_produtoVIEW.php"><svg xmlns="http://www.w3.org/2000/svg" id="icone" width="30" height="30" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
...
<form method="post" name="produto" action="cad_produtoAPAGAR-LINHA.php">
    <div class="row">
        <div class="col-md-12">
            <h1 style="text-align: center;">Exclusão dos produtos</h1>
        </div>
...
<!-- para alterações -->
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" name="txtdescricao" value='<?php echo $dados['descricao'];?>' readonly class="form-control">
                </div>
                <!-- chamando o valor da quantidade -->
                <div class="col-md-1 form-group">
                    <label>Quantidade</label>
                    <input type="number" name="txtquant" value='<?php echo $dados['quantidade'];?>' readonly class="form-control">
                </div>
                <!-- chamando o valor do preço -->
                <div class="col-md-1 form-group">
                    <label>Preço</label>
                    <input type="text" name="txtpreco" value='<?php echo $dados['preco'];?>' readonly class="form-control">
                </div>
                <!-- chamando o valor do lote -->
                <div class="col-md-4 form-group">
                    <label>Lote</label>
                    <input type="text" name="txtlote" value='<?php echo $dados['lote'];?>' readonly class="form-control">
                </div>
                <!-- chamando o valor da data -->
                <div class="col-md-2 form-group">
                    <label>Data de válidade</label>
                    <input type="date" name="txtdata" value='<?php echo $dados['data_validade'];?>' readonly class="form-control">
                </div>
                <!-- chamando o valor do código de barras -->
                <div class="col-md-4 form-group">
                    <label>Código de barras</label>
                    <input type="number" name="txtcodBarras" value='<?php echo $dados['cod_barras'];?>' readonly class="form-control">
                </div>
                <!-- chamando o valor do fornecedor -->
                <div class="col-md-4 form-group">
                    <label>Fornecedor</label>
                    <input type="text" name="txtfornecedor" value='<?php echo $dados['fornecedor'];?>' readonly class="form-control">
                </div>
                <!-- separação -->
