...
$consulta1 = "SELECT max(id) as id FROM venda_produto";
...
$id_cli = $dado['id'];
$nome_cli = "select venda_produto.id_cliente, cad_cliente.nome from venda_produto, cad_cliente where venda_produto.id = $id_cli and venda_produto.id_cliente = cad_cliente.id";
                    ...
                    <div class="col-sm-12 col-md-6">
                        <!-- dados -->
                            ...
                            <div class="" style="margin: 20px">
                                <h5>Codigo:</h5>
                                <input class="form-control" type="text" style="width: 100px;" name="txtcodigo" value='<?php echo $dado_cli['id_cliente']; ?>' readonly>
                                <h5>Nome Cliente:</h5>
                                <input class="form-control" type="text" name="txtdesc" maxlength='80' style="width:550px" value='<?php echo $dado_cli['nome']; ?>'readonly>
                            </div>
                            <div style="margin: 20px">
                                <a href="cad_vendasVIEW.php" class="btn btn-info" role="button">
                                    Finalizar Venda
                                </a>
                                <a href="cad_consultaVENDAproduto.php?id_venda=<?php echo $id_cli; ?>" class="btn btn-info" role="button" target="_blank">
                                    Consultar Venda
                                </a> 
                        ...
                        <div class="" style="margin-left: 20px">
                            <button class="btn btn-info" data-toggle="modal" data-target="#idmodal<?php echo $id_cli; ?>">
                                Consultar venda teste
                            </button>
                        </div>

                        <!-- MODALLLLL -->
                        <div class="modal fade" id="idmodal<?php echo $id_cli; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-content" id="modal-color">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php
                                            ...
                                            $consulta = "SELECT cad_produto.id, cad_produto.descricao, itens_venda.id_venda, itens_venda.id_produto, itens_venda.quantidade, itens_venda.preco FROM cad_produto, itens_venda WHERE itens_venda.id_venda = $id_cli and itens_venda.id_produto = cad_produto.id";  
                                            $conn = @mysqli_query($conexao,$consulta) or die($mysqli -> error); 

                                            //fazendo select para exibição do total da venda
                                            $preco = "SELECT sum(preco * quantidade) as total FROM itens_venda where id_venda = $id_cli"; 
                    ...
                    <?php while ($dado = $con->fetch_array()) { ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="cad_itensVENDAS.php?codigo=<?php echo $dado['id']; ?>&id_venda=<?php echo $id_cli; ?>&preco=<?php echo $dado['preco']; ?>&qtd=1" class="btn btn-info" role="button">
                                        Adicionar
                                    </a>
                                </td>
                            </tr>
